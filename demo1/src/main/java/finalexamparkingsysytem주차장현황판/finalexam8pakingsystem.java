package finalexamparkingsysytem주차장현황판;
 ...
 * </ul>
 */
public class finalexam8pakingsystem {
    ...
    public static void main(String[] args) {
        finalexam8pakingsystem app = new finalexam8pakingsystem();
        app.simulateParking();
