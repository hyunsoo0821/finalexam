...
# 3.2 클래스 다이어그램 
># 첫번째가 중간고사 계산기 내용 참고하여 만든 설문조사 코드이며
> >## 두번째가 기말고사 내용 참고하여 컬랙션프레임워크와 파일입출력을 활용한 설문조사 코드입니다
...
#4.1 결론 느낀점
> **자바언어로 파일 내보내기 형식중 택스트 파일, csv파일만 가능하여 프로그램을 짤때 한계점이 많았다**
> > **하지만 지금까지 자바언어로 배운 기능을 잘 활용한다면 개발이 어렵지만 않게 느껴진다.**
> > **물론 아직 언어밖에 안배웠지만 계속 프로그램을 짜보고 프로그래밍에 대해 공부하여 기능과 생산형AI에 의존할게 아니라 먼저 프로그램을 짜기 위한 설계를 구상하고 어떤 클래스를 사용할지 구상이 먼저라는걸 깨달았다**
